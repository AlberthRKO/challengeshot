  ...
  var Core = {
    ...
    headerNav: function () {
      ...
      if (mainNav.exists()) {
        ...
        navListLi
          ...
          .append('<span class="main-nav__toggle">&nbsp;</span>');
        navListLi
    ...
    dlNav: function () {
      ...
      if (dlNav.exists()) {
        ...
        navListLi
          .has(".dl-submenu")
          .addClass("has-children")
          .append('<span class="dl-toggle">&nbsp;</span>');
        $(".dl-menu > li > ul > li")
          .has(".dl-submenu")
          .addClass("has-children")
          .append('<span class="dl-toggle">&nbsp;</span>');
    ...
    mobileNav: function () {
      ...
      if (mobileNav.exists()) {
        ...
        navListLi
          .has(".mobile-nav__sub")
          .addClass("has-children")
          .prepend('<span class="mobile-nav__toggle">&nbsp;</span>');
        navListLi
          .has(".mobile-nav__megamenu")
          .addClass("has-children")
          .prepend('<span class="mobile-nav__toggle">&nbsp;</span>');
        ...
        $(".mobile-nav__toggle").on("click", function () {
          ...
          $(".mobile-nav__sub, .mobile-nav__megamenu")
            .not($(this).siblings(".mobile-nav__sub, .mobile-nav__megamenu"))
            .slideUp("normal");
        ...
        // Add toggle button and class if submenu has sub-submenu
        $(".mobile-nav__list > li > ul > li")
          .has(".mobile-nav__sub-2")
          .addClass("has-children")
          .prepend('<span class="mobile-nav__toggle-2">&nbsp;</span>');
        $(".mobile-nav__list > li > ul > li > ul > li")
          .has(".mobile-nav__sub-3")
          .addClass("has-children")
          .prepend('<span class="mobile-nav__toggle-2">&nbsp;</span>');
    ...
    headerCart: function () {
      ...
      if (cartToggle.exists()) {
        var toggleCart = function () {
          ...
          if (
            _windowWidth < 768 &&
            siteWrapper.hasClass("site-wrapper--has-menu-overlay")
          ) {
            menuToggle.toggleClass("toggled");
            topBarToggle.toggleClass("hide");
            siteWrapper.toggleClass("site-wrapper--has-menu-overlay");
    ...
    isotope: function () {
      ...
      if (armas.exists()) {
        ...
        isotopeGrid = armas.imagesLoaded(function () {
          isotopeGrid.isotope({
            layoutMode: layout,
            itemSelector: ".post",
          });
    ...
    slickCarousel: function () {
      ...
      if (slick_top_bar_carousel.exists()) {
        slick_top_bar_carousel.slick({
          ...
          variableWidth: true,
          prevArrow:
            "<button class='slick-prev'><svg role='img' class='df-icon df-icon--left-arrow'><use xlink:href='assets/img/necromancers.svg#left-arrow'/></svg></button>",
          nextArrow:
            "<button class='slick-next'><svg role='img' class='df-icon df-icon--right-arrow'><use xlink:href='assets/img/necromancers.svg#right-arrow'/></svg></button>",
          responsive: [
            {
              breakpoint: 768,
              settings: "unslick",
      ...
      if (slick_widget_partners.exists()) {
        ...
        var widgetTitleWidth =
          $(".widget__title", slick_widget_partners).width() + 34;

        $(document).ready(function () {
          $(".slick-arrow", slick_widget_partners)
            .appendTo(slick_widget_partners)
            .css({ left: widgetTitleWidth });
        });
      ...
      if (slick_player_info_carousel_1.exists()) {
        slick_player_info_carousel_1.on("init", function (event, slick) {
          ...
          slick_player_info_carousel_1.append(
            '<div class="slick-custom-pagination">' + pagination + "</div>"
          );
        });
        ...
        slick_player_info_carousel_1.on(
          "afterChange",
          function (event, slick, currentSlide) {
            var pagination = slick.currentSlide + 1 + "/" + slick.slideCount;
            var paginationContainer = $(
              "#player-info-carousel-1 .slick-custom-pagination"
            );
      ...
      if (slick_player_info_carousel_2.exists()) {
        slick_player_info_carousel_2.on("init", function (event, slick) {
          var pagination = slick.currentSlide + 1 + "/" + slick.slideCount;
          slick_player_info_carousel_2.append(
            '<div class="slick-custom-pagination">' + pagination + "</div>"
          );
        });
        ...
        slick_player_info_carousel_2.on(
          "afterChange",
          function (event, slick, currentSlide) {
            var pagination = slick.currentSlide + 1 + "/" + slick.slideCount;
            var paginationContainer = $(
              "#player-info-carousel-2 .slick-custom-pagination"
            );
            paginationContainer.html(pagination);
          }
        );
    ...
    googleMap: function () {
      ...
      if (gmap.exists()) {
        gmap.each(function () {
          var $elem = $(this);
          var mapAddress = $elem.attr("data-map-address")
            ? $elem.attr("data-map-address")
            : "New York, USA";
          var mapZoom = $elem.attr("data-map-zoom")
            ? $elem.attr("data-map-zoom")
            : "15";
          var mapIcon = $elem.attr("data-map-icon")
            ? $elem.attr("data-map-icon")
            : "";
          var mapStyle = $elem.attr("data-map-style");
          var mapInfo = $elem.children().html()
            ? $elem.children().html()
            : false;
    ...
    socialGlitchEffect: function () {
      ...
      var logoMenuLandingGlitch = $(".logo-menu--landing-glitch");
      ...
      if (logoMenuLandingGlitch.exists()) {
        $(".logo-menu--landing-glitch > a").each(function () {
          var iconClone = $(this)
            .find('[class*="fa-"]')
            .clone()
            .addClass("glitch-layer");
    ...
    miscScripts: function () {
      ...
      $("#dl-menu").dlmenu({
        ...
        backLabel:
          '<svg role="img" class="df-icon df-icon--left-arrow"><use xlink:href="assets/img/necromancers.svg#left-arrow"></use></svg>' +
          " " +
          "Back",
      });
